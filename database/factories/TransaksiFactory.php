    ...
    public function definition(): array
    {
        ...
        return [
            'connote' => [
                ...
                'connote_booking_code' => $this->faker->regexify('[A-Z0-9]{10}'),
            ...
            'custom_field' => [
                'first_attempt_time' => $this->faker->randomElement(['BERHASIL', 'GAGAL']),
                'reason_failedtodelivered' => $this->faker->randomElement(['Pengiriman berhasil', 'Pengiriman dibatalkan']),
